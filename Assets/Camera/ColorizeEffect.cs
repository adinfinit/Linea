...
public class ColorizeEffect : MonoBehaviour
{
	...
	void OnRenderImage (RenderTexture source, RenderTexture destination)
	{
		...
		RenderTexture backgroundTexture = backgroundCamera.targetTexture;
		RenderTexture levelTexture = levelCamera.targetTexture;
		RenderTexture textTexture = textCamera.targetTexture;
